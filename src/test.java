...
//         * @return
//         */
//        public List<KDNode> nearestNeighbor(KDPoint target) {
//            List<KDNode> result = new ArrayList<>();
//            nearestNeighbor(root, target,Integer.MAX_VALUE, 0,result);
//            return result;
//        }
//
//        /**
...
//         * @return
//         */
//        private void nearestNeighbor(KDNode root, KDPoint target, int minDistance, int depth, List<KDNode> result) {
//
//            if (root == null) return;
//
//            int distance = (int)Math.round(Math.sqrt(distSquared(target, root.point)));
...
//            nearestNeighbor(nextBranch, target,minDistance, depth + 1,result);
//// 		KDNode best = closest(result.get(result.size()-1),	root, target);
//
//            long radiusSquared = distSquared(target, result.get(result.size()-1).point);
//
//            /*
...
//                nearestNeighbor(otherBranch, target, minDistance,depth + 1,result);
...
//
//            for (int[] coord : ar) {
//                KDNode n = new KDNode(Arrays.asList(coord[0], coord[1],coord[2]));
//                tree.add(n);
//            }
//
//            System.out.println("tree=" + tree.toString());
//            System.out.println(tree.nearestNeighbor(new KDPoint(Arrays.asList(0,0,0))));
//
//        }
//    }
//}
